...
export default function SideNavbar({
  ...
  // Refresh data periodically to catch changes - increased interval to reduce excessive calls
  useEffect(() => {
  ...
  // Debug contact modal state
  useEffect(() => {
    console.log('🔍 contactOpen state changed to:', contactOpen);
  }, [contactOpen]);
