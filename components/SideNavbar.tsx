...
export default function SideNavbar() {
  ...
  const navItems = [
    { icon: "/home-icon.png", label: "Home", href: "/home", active: pathname === "/home" },
    { icon: "/missions-icon.png", label: "Missions", href: "/missions", active: pathname === "/missions" },
    hasCompletedMission2
      ? { icon: "/playground-active.png", label: "Playground", href: "/playground", active: pathname === "/playground" }
      : { icon: "/playground-icon-dissabled.png", label: "Playground", href: "#", disabled: true as const },
    { icon: "/demo-icon.png", label: "Demo", href: "/demo", active: pathname === "/demo" },
    { icon: "/projects-icon.png", label: "Projects", href: "/projects", active: pathname === "/projects" },
  ];
  ...
  const submitContact = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        setSendError((data as { message?: string })?.message || "Failed to send. Please try again.");
        setSending(false);
        return;
      }
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderTopRightRadius: "24px", borderBottomLeftRadius: "24px", zIndex: 1 }}
      />
      <div
        className="absolute bottom-0 right-0 w-6 h-6 bg-[#F8F9FC]"
        style={{ borderBottomRightRadius: "24px", borderTopLeftRadius: "24px", zIndex: 1 }}
      />

      {/* Logo */}
      <div className={`mb-8 w-full flex justify-center ${sidebarCollapsed ? "px-0" : "px-2"}`} style={{ zIndex: 2 }}>
        <div className={`bg-white rounded-2xl flex items-center justify-center ${sidebarCollapsed ? "w-14 h-14" : "w-[150px] h-[50px]"}`}>
          <Image src={sidebarCollapsed ? smallLogo : sideLogo} alt="BuddyNeo Logo" />
        </div>
      </div>

      {/* Navigation */}
      <div className="flex-1 flex flex-col justify-center items-center w-full" style={{ zIndex: 2 }}>
        <nav className={`flex flex-col ${sidebarCollapsed ? "gap-4" : "gap-6"} items-start w-full ${sidebarCollapsed ? "pl-2" : "pl-8"}`}>
          {navItems.map((item) =>
            "disabled" in item && item.disabled ? (
              ...
              >
                ...
                {!sidebarCollapsed && (
                  <span className="text-base font-semibold" style={{ color: "#BDC8D5" }}>
                    {item.label}
                  </span>
                )}
              </div>
              ...
              <Link
                ...
                className={`flex flex-row items-center gap-3 ${
                  ...
                  item.active ? "border border-[#00AEEF] bg-white shadow-sm" : "hover:bg-[#F0F4F8] transition-colors"
                }`}
              >
                <Image src={item.icon} alt={item.label} width={24} height={24} />
                {!sidebarCollapsed && (
                  <span className="text-base font-semibold text-[#222E3A]">{item.label}</span>
                )}
              </Link>
            )
          )}
          ...
          >
            ...
            {!sidebarCollapsed && (
              <span className="text-base font-semibold text-[#222E3A]">Help</span>
            )}
              ...
              >
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" stroke="#111827" strokeWidth="1.5"/>
                    <path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3M12 17h.01" stroke="#111827" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  FAQ
                </button>
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke="#111827" strokeWidth="1.5"/>
                    <path d="M22 6l-10 7L2 6" stroke="#111827" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  Contact Us
                </button>
              </div>
      ...
      <div className="w-full flex flex-col items-center mb-2 gap-2" style={{ zIndex: 2 }}>
        <div
          ref={menuContainerRef}
          className={`relative bg-white rounded-2xl shadow-sm mt-2 ${
            sidebarCollapsed ? "w-12 px-0" : "w-[90%] px-3"
          } flex items-center ${sidebarCollapsed ? "flex-col justify-center" : "flex-row justify-between"}`}
        >
          {/* Avatar + Name link */}
          <Link
            href="/profile"
          ...
          {menuOpen && (
            ...
            >
              ...
              <div
                className={`absolute ${
                  sidebarCollapsed ? "left-1/2 -translate-x-1/2 -bottom-2" : "right-4 -bottom-2"
                } w-3 h-3 bg-white rotate-45 border-r border-b border-gray-100`}
              />
              <button
                className="w-full flex items-center gap-2 text-left px-4 py-2.5 hover:bg-gray-50 text-sm text-black"
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path d="M12 8.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z" stroke="#111827" strokeWidth="1.8" />
                  <path d="M19.4 15l1.6.9-1.6 2.8-1.6-.9a7.8 7.8 0 01-1.9 1.1l-.3 1.8h-3.2l-.3-1.8a7.8 7.8 0 01-1.9-1.1l-1.6.9L3 15.9l1.6-.9A7.4 7.4 0 014 12c0-1.1.2-2.1.6-3.1L3 8l1.6-2.8 1.6.9c.6-.5 1.2-.8 1.9-1.1l.3-1.8h3.2l.3 1.8c.7.3 1.3.6 1.9 1.1l1.6-.9L21 8l-1.6.9c.4 1 .6 2 .6 3.1 0 1.1-.2 2.1-.6 3z" stroke="#111827" strokeWidth="1.2"/>
                </svg>
                Settings
              </button>
              <div className="h-px bg-gray-100" />
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path d="M15 17l5-5-5-5" stroke="#DC2626" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M20 12H9" stroke="#DC2626" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M12 19a7 7 0 110-14" stroke="#DC2626" strokeWidth="1.2"/>
                </svg>
                Logout
              </button>
            </div>
        ...
        >
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl border border-gray-100 w-[92vw] max-w-[520px] p-6 z-[10000]">
            ...
            <p className="text-sm text-[#475569] mb-4">
              Send us a message and we’ll email you back at <span className="font-semibold">info@magicbit.cc</span>.
            </p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  ...
                  maxLength={1500}
                />
                <div className="text-xs text-[#94a3b8] self-end">{contactMessage.length}/1500</div>
              </div>

              {/* Attachment */}
              <div className="flex flex-col gap-1">
                <label className="text-sm text-[#6B7280]">Attachment (optional)</label>
                ...
                >
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path d="M12 5v14M5 12h14" stroke="#64748B" strokeWidth="2" strokeLinecap="round" />
                  </svg>
                  <span className="text-sm text-[#64748B]">
                    {contactFile ? `Selected: ${contactFile.name}` : "Click to upload or drag & drop an image"}
                  </span>
                  <input
                    id="contact-file"
                    type="file"
              ...
              <div className="mt-2 flex items-center justify-end gap-3">
                ...
                <button
                  className={`px-4 py-2 rounded-xl text-white ${sending ? "bg-[#7ccfea]" : "bg-[#00AEEF] hover:brightness-110"}`}
