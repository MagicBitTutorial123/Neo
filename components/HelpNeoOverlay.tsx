      ...
      <div className="flex flex-row items-center justify-start w-full max-w-5xl mx-auto">
        <div className="flex flex-col items-center justify-center flex-1 -ml-40">
          ...
          <div className="flex gap-8 mt-8 justify-center">
            <button
              onClick={onLater}
              className="px-6 py-2 rounded-full bg-white text-black font-bold text-base focus:outline-none focus:ring-2 focus:ring-[#B3E6FF] transition"
            >
              {laterText}
            </button>
            <button
              onClick={onHelp}
              className="px-6 py-2 rounded-full bg-black text-white font-bold text-base focus:outline-none focus:ring-2 focus:ring-white transition border border-white"
            >
              {helpText}
            </button>
          </div>
