            ...
            <div className="h-full p-4 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 pt-10 pb-8">
              ...
              <div className="flex justify-between items-center px-2 mb-4 mt-8">
                ...
                <div className="flex gap-3">
                   ...
                   {onUploadCode && (
                     <button
                       onClick={() => onUploadCode(generatedCode)}
                       disabled={!generatedCode || isUploading}
                       className="px-6 py-2 rounded-full font-medium bg-[#599CFF] text-white hover:bg-[#8ebbff] transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center gap-2"
                     >
                       {isUploading ? (
                         <>
                           <svg
                  ...
                  {currentStep < mission.steps.length - 1 ? (
                    <button
                      onClick={handleNext}
                      className="w-24 px-4 py-2 rounded-full font-medium bg-black text-white hover:bg-[#222E3A] transition-colors"
                    >
                      Next
                    </button>
                  ) : (
