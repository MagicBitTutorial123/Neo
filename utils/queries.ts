...
export async function isMissionAlreadyCompleted(userId: string, missionId: string): Promise<boolean> {
  console.log(`🎯 [isMissionAlreadyCompleted] Called with userId: ${userId}, missionId: ${missionId}`);
  try {
    const userData = await getUserProgress(userId);
    console.log(`🎯 [isMissionAlreadyCompleted] User data retrieved:`, userData);
    if (!userData) {
      console.log(`🎯 [isMissionAlreadyCompleted] No user data found, returning false`);
    ...
    console.log(`🎯 [isMissionAlreadyCompleted] Mission ${missionId} (parsed: ${missionNumber}) vs currentMission: ${currentMission}`);
    ...
    const isCompleted = missionNumber <= currentMission;
    console.log(`🎯 [isMissionAlreadyCompleted] Mission ${missionId} completed: ${isCompleted}`);
