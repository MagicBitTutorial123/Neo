          ...
          <form className="flex flex-col gap-4 w-full max-w-[400px] items-center">
            ...
            <div className="flex items-center justify-center w-full gap-4 mb-2 relative">
              <input
                ...
                inputMode="text"
                maxLength={32}
                className="w-full bg-white rounded-full shadow-sm px-6 py-4 pr-12 text-lg text-center font-poppins border-none outline-none text-black placeholder:text-gray-400 mb-4"
                value={password}
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 p-1 focus:outline-none hover:bg-gray-100 rounded-full transition-colors"
                tabIndex={-1}
