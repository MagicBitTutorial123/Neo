...
export default function ProgressPage() {
  ...
  // Badges data
  const badges = [
    { id: 1, name: "FIRST SPARK", src: "/badge1.png", alt: "Badge1", earned: true, description: "Complete your first mission" },
    { id: 2, name: "CIRCUIT MASTER", src: "/badge2.png", alt: "Badge2", earned: true, description: "Master circuit building" },
    { id: 3, name: "BATTLE READY", src: "/badge3.png", alt: "Badge3", earned: false, description: "Complete 5 missions" },
    { id: 4, name: "INNOVATOR", src: "/badge4.png", alt: "Badge4", earned: false, description: "Create your first project" },
    { id: 5, name: "CODING WIZARD", src: "/badge5.png", alt: "Badge5", earned: false, description: "Complete 10 missions" },
    { id: 6, name: "ROBOT BUILDER", src: "/badge6.png", alt: "Badge6", earned: false, description: "Build your first robot" },
  ];
  ...
  const getAIResponse = (message: string) => {
    ...
    } else if (lowerMessage.includes("badge") || lowerMessage.includes("earn")) {
      return "You can earn badges by completing missions and achieving milestones. Check your progress to see available badges!";
    } else if (lowerMessage.includes("circuit") || lowerMessage.includes("building")) {
    ...
    <BasicAuthGuard>
      <div className="flex min-h-screen bg-[#F8F9FC]">
          ...
          <div className="p-8">
            <div className="max-w-sm mx-auto">
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
                ...
                <div className="text-sm font-medium text-[#222E3A]">#TopBadge</div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-2xl border border-[#E0E6ED] p-6 shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl font-bold text-[#222E3A]">Mission Progress</h2>
                    <button
                    ...
                    >
                      ...
                      <svg 
                        className={`w-4 h-4 transition-transform ${showAllMissions ? 'rotate-180' : ''}`} 
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
                  ...
                  <MissionListView 
                    missions={showAllMissions ? Object.values(missions) : Object.values(missions).slice(0, 3)}
                    completedCount={currentMissionProgress}
                    onMissionSelect={setSelectedMission}
                    selectedMission={selectedMission}
                  />
                  
                  {!showAllMissions && Object.values(missions).length > 3 && (
                    <div className="text-center mt-4 text-sm text-[#6B7280]">
                      +{Object.values(missions).length - 3} more missions
                    </div>
                  )}
                </div>
        ...
        <div className="fixed bottom-8 right-8 z-40">
          ...
          >
            <svg className={`w-6 h-6 transition-transform duration-300 ${showChatbot ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#222E3A] text-sm">AI Assistant</h3>
